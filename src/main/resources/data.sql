...
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (10, 'javamonkey', 'howard_the_temp', 'ryan');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (11, 'javamonkey', 'hudson', 'stanley');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (12, 'javamonkey', 'palmer', 'meredith');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (13, 'designmonkey', 'beesly', 'pam');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (14, 'designmonkey', 'bratton', 'creed');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (15, 'designmonkey', 'flax', 'holly');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (16, 'frontendmonkey', 'martin', 'angela');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (17, 'frontendmonkey', 'martinez', 'oscar');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (18, 'frontendmonkey', 'kapoor', 'kelly');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (19, 'backendmonkey', 'vance', 'phyllis');
INSERT INTO `person` (`person_id`, `competence`, `last_name`, `name`) VALUES (20, 'backendmonkey', 'schrute', 'dwight');
