...
INSERT INTO `users` (`user_id`, `user_name`, `password`, `active`, `person_id`) VALUES (5, 'projectman1', '$2a$10$EZ1TVvvwsiHGnjXtmeMOQuJFlUXpxI4kjOGdOPhLD6o9kAzWqh38y', 1, 5);
INSERT INTO `users` (`user_id`, `user_name`, `password`, `active`, `person_id`) VALUES (6, 'projectman2', '$2a$10$EZ1TVvvwsiHGnjXtmeMOQuJFlUXpxI4kjOGdOPhLD6o9kAzWqh38y', 1, 6);
INSERT INTO `users` (`user_id`, `user_name`, `password`, `active`, `person_id`) VALUES (7, 'projectman3', '$2a$10$EZ1TVvvwsiHGnjXtmeMOQuJFlUXpxI4kjOGdOPhLD6o9kAzWqh38y', 1, 7);
